...
while True:
    ...
    print('updated battle locs: ', variables.battle_locations)
    ...
    try:
        ...
        for unit in gc.my_units():
            ...
            if unit.unit_type == bc.UnitType.Worker:
                ...
                ranger.timestep(gc,unit,info,last_turn_battle_locs, next_turn_battle_locs, queued_paths, ranger_roles, direction_to_coord, precomputed_bfs, targeting_units, bfs_fineness)
            elif unit.unit_type == bc.UnitType.Mage:
